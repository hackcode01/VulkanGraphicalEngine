...
/* keyboard input. */
API b8 inputIsKeyDown(keys_t key);
API b8 inputIsKeyUp(keys_t key);
API b8 inputWasKeyDown(keys_t key);
API b8 inputWasKeyUp(keys_t key);

void inputProcessKey(keys_t key, b8 pressed);

/* mouse input. */
API b8 inputIsButtonDown(buttons_t button);
API b8 inputIsButtonUp(buttons_t button);
API b8 inputWasButtonDown(buttons_t button);
API b8 inputWasButtonUp(buttons_t button);
API void inputGetMousePosition(i32* x, i32* y);
API void inputGetPreviousMousePosition(i32* x, i32* y);
