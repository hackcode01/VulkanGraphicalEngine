...
/* Keyboard input. */
ENGINE_API b8 inputIsKeyDown(Keys key);
ENGINE_API b8 inputIsKeyUp(Keys key);
ENGINE_API b8 inputWasKeyDown(Keys key);
ENGINE_API b8 inputWasKeyUp(Keys key);

void inputProcessKey(Keys key, b8 pressed);

/* Mouse input. */
ENGINE_API b8 inputIsMouseButtonDown(MouseButtons button);
ENGINE_API b8 inputIsMouseButtonUp(MouseButtons button);
ENGINE_API b8 inputWasMouseButtonDown(MouseButtons button);
ENGINE_API b8 inputWasMouseButtonUp(MouseButtons button);
ENGINE_API void inputGetMousePosition(i32* x, i32* y);
ENGINE_API void inputGetPreviousMousePosition(i32* x, i32* y);
