...
typedef b8 (*PFNOnEvent)(u16 code, void* sender, void* listenerInstance,
                         eventContext_t data);
 ...
 */
API b8 eventRegister(u16 code, void* listener, PFNOnEvent onEvent);
 ...
 */
API b8 eventUnregister(u16 code, void* listener, PFNOnEvent onEvent);
 ...
 */
API b8 eventFire(u16 code, void* sender, eventContext_t context);
